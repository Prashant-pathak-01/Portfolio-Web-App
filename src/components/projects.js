  ...
  return (
    <div className='projects'>
      ...
      <div className='project_list'>
        ...
        <a href='https://hospital-management-system-project.netlify.app/' target='_blank'><MyProject img={HospitalManagementProject} topic="To do Web App" domain="Web Application"></MyProject></a>
