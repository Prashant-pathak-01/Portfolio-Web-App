    ...
    <div className='skillsandexperiences'>
        ...
        <div className='skillsandexp'>
            ...
            <div className='Experience'>
              ...
              <ul>
                <li>Solved around 700+ DSA problems with the highest rating of 1609 on LeetCode.</li>
                <li>Ranked 285 among 3300+ competitive programmers in GeeksforGeeks weekly coding contest 139. <a href="https://practice.geeksforgeeks.org/contest/gfg-weekly-coding-contest-139/leaderboard" target="_blank">Link</a></li>
                <li>Secured a global rank of 2386 in LeetCode Biweekly Contest 126 among 28K+ participants. <a href="https://leetcode.com/contest/biweekly-contest-126/ranking" target="_blank">Link</a></li>
                <li>Secured a global rank of 614 in CodeChef Starters 120 weekly contest. <a href="https://www.codechef.com/rankings/START120C?itemsPerPage=100&order=asc&page=1&sortBy=rank" target="_blank">Link</a></li>
                <li>Solved more than 1000+ problems across platforms.</li>
              </ul>
            </div>
        </div>
    </div>
